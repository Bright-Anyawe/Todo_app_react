...
const Form = () => {
  ...
  function handleToDoObj() {
    const toDoObject = {
      task: taskTitleescription: description,
      priority: priority,
      date: date,
      count: count,
    };

    setToDoList((prevState) => ({ ...prevState, toDoList: toDoObject }));
      ...
      <section className="formContainer">
        ...
        <div className="btnContainer">
          <div className="svgControl">
            ...
            <button id="submitBtn" onClick={() => {handleCount}}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <title>check</title>
