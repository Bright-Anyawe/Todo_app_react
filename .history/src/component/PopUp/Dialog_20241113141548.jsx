...
export default function FormDialog() {
  ...
  const handleSubmit = (e) => {
    ...
    console.log(updatedProjects);
      ...
      if (
        ["Inbox", "Today", "Tomorrow", "ThisWeek", "Completed"].includes(
          selectedProjectName
        )
      ) {
        // Navigate to the predefined path for known project names
        navigate(`/display/${selectedProjectName.toLowerCase()}`);
      } else {
        // Navigate to the custom project route
    ...
    if (selectedProjectName === "Inbox") {
      ...
      // Navigate to ProjectComponent if a custom project is selected
    ...
    // if (["Inbox", "Today"].includes(selectedProjectName)) {
    //   navigate(`/display/${selectedProjectName.toLowerCase()}`);
    // } else if (!location.pathname.includes("/display/project")) {
    //   navigate("/display/project");
    // }
 if (["Inbox", "Today", "Tomorrow", "ThisWeek", "Completed"].includes(selectedProjectName)) {
   navigate(`/display/${selectedProjectName.toLowerCase()}`);
 } 
