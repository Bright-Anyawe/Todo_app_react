...
export default function FormDialog() {
  ...
  const handleSubmit = (e) => {
    ...
    } else if (selectedProjectName === "Completed") {
      if (selectedTodo) {
        handleSaveTodo(state);
      } else {
        setProjects(updatedProjects);
    ...
    if (
      ...
      navigate(`/display/${convertedName.toLowerCase()}`);
    } else if (
      selectedProjectName !== "Completed" &&
      !location.pathname.includes(selectedProjectName.toLowerCase())
    ) {
