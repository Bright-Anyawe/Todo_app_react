...
export default function FormDialog() {
  ...
  const { taskTitle, description, priority, date } = state;
  ...
  const handleSubmit = (e) => {
    ...
    if (name === "inbox") {
      if (selectedTodo) {
      handleSaveTodo(state);  // Update the task in the inboxToDos list
    } else {
      setInboxToDos((prevToDos) => {
        ...
        return updatedToDos;
            ...
            setTodayCount(todayCount + 1);  // Increase count only for new tasks
