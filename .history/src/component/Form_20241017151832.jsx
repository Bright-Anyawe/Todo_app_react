        ...
        <form action="" id="form">
          ...
          <div className="btnContainer">
            <div className="buttonsFlex">
              ...
              <button id="submitBtn"><svg viewBox="0 0 24 24" role="presentation" class="MuiChip-icon MuiChip-iconMedium MuiChip-iconColorCurrentColor" style="width: 1.2rem; height: 1.2rem;"><path d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" style="fill: currentcolor;"></path></svg></button>
            </div>
          </div>
        </form>
      </section>
