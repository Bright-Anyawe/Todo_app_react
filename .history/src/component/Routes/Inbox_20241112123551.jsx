...
export function Inbox() {
  ...
  const inboxToDos = projects.name === "inbox" ? projects.todos : null
  ...
  const handleDelete = (index) => {
    ...
    setProjects((prevProjects) => ({
      ...
      return prevProjects.map()
  const inboxTodos = prevProjects.name === "inbox"? prevProjects.todos : null
  [...inboxTodos, updatedTodos]
    }));
  };
