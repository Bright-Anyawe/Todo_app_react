...
export function Completed() {
  const { completedToDos, setCompletedCount } = useContext(GeneralContext);
  ...
  const completedToDos =
    projects.find((project) => project?.name === "Completed")?.todos || [];
  console.dir(completedToDos, { depth: null });
   ...
   useEffect(() => {
     ...
     if (storedProjects && storedProjects.length) {
       ...
       const completedToDos =
         storedProjects.find((project) => project?.name === "Completed")
           ?.todos || [];
