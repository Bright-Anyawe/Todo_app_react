...
console.log(toDoList)
  ...
  function handleToDoObj(updateTaskTitle, updateDescription, updatePriority, updateDate) {
    const toDoObject = {
      ...taskObj,
    ...
    setToDoList((prevState) => ({
      ...prevState, toDos: prevState.toDos.concat(taskObj)
    }))
  ...
  // //   setToDoList((prevState) => ({
  // //     ...prevState,
  // //     toDos: prevState.toDos.concat(toDoObject),
  // //   }));
  // }
